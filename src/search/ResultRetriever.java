...
import luceneHelpClasses.DocumentHandler;
import luceneHelpClasses.PDFHandler;
import luceneHelpClasses.RequiredHighlight;
import luceneHelpClasses.ResultData;
import luceneHelpClasses.SerbianAnalyzer;
...
public class ResultRetriever {
	...
	public static List<ResultData> getResults(Query query,
		...
		try {
			Directory indexDir = new SimpleFSDirectory(new File(resourceBundle.getString("index")));
			...
			for (ScoreDoc sd : hits) {
				...
				for (RequiredHighlight rh : requiredHighlights) {
					...
					System.out.println("pokusaj necega");
					try{
