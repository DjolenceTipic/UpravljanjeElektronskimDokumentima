	...
	public Document getDocument(File file) {
		...
		try {
			...
			doc.add(new StringField("filename", file.getCanonicalPath(),
					Store.YES));
			String language = ""+info.getCustomMetadataValue("language");
			System.out.println(language);
			doc.add(new TextField("language", language,  Store.YES));
			
			String category = ""+info.getCustomMetadataValue("category");
			System.out.println(category);
			doc.add(new TextField("category", category,  Store.YES));
